...
| Break concentration risk | top user ≥ 60% of total | Review that user's workload; move repetitive jobs to licence-included Chat/Work IQ (see m365-cost-advisor) | Cuts the single biggest cost driver |
